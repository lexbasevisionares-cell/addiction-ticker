...
export const TRANSLATIONS = {
    ...
    infoLostNowDesc: 'Reaalisoitu rahanmeno. Tämä on puhdas rahasumma, jonka olet luovuttanut yhtiöille tämän sovelluksen käynnistymisestä tähän sekuntiin mennessä.',
    ...
    infoLostInvestmentDesc: 'Menetetty korkoa korolle -tuotto. Osoittaa, mihin arvoon tähän mennessä kulutettu rahasi olisi kasvanut asetetussa ajassa, jos olisit sijoittanut sen markkinoille.',
