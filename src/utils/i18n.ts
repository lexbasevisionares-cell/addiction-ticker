...
export const TRANSLATIONS = {
    ...
    infoLogicHookedP2_2: '.',
    infoLogicHookedP3: ' Varma rahareikä: Ennuste nikotiiniin puhtaasti kuluvasta rahasta, huomioiden arvioimasi vuotuisen hinnannousun.',
    infoLogicHookedP4: ' Menetetty varallisuus: Kokonaissumma, jonka ',
    infoLogicHookedP4_1: 'olisit voinut kerryttää sijoitussalkkuun',
    infoLogicHookedP4_2: ' samassa ajassa — sisältäen sekä suorat säästöt että niille kertyvän korkoa korolle -tuoton.',
