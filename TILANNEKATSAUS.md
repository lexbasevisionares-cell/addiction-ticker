...
| Komponentti | Kuvaus |
|---|---|
| `App.tsx` | Pää-reititin, tilan hallinta |
...
| `Onboarding.tsx` | Asennusvelho (WheelPicker-kysymykset) |
| `OnboardingWelcome.tsx` | Ensimmäinen tervetuloruutu |
...
| `SideDrawer.tsx` | Asetukset-sivupaneeli |
...
Sovellus on nyt TestFlightissa. Seuraavat askeleet kohti julkista App Store -julkaisua:
